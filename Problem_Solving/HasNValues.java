...
public class HasNValues {
     ...
     * integer n as arguments. It returns true if all the elements of the
     * array are one of n different values.
     * 
     ...
     * make
     * to the array in your function will be visible when the function returns.
